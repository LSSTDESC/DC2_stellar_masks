...
class Multiprocessing:
    def __init__(self, config_file = f'{current_dir}/../../config/config.yaml', tract_list = None):
    ...
    def slurm_submit(self, func_name="multi_radius_study", outpath = current_dir+"/logs/"):
        slurm_mem = 64
        ...
        result =  np.zeros((len(self.tract_list),len(self.bins)-1, len(self.theta_bins))) #create empty arry to store results
